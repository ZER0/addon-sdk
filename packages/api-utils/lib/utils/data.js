...
exports.getChromeURIContent = function deprecated_getChromeURIContent() {
  console.error('require("api-utils/utils/data").getChromeURIContent is ' +
                'deprecated, please use require("api-utils/url/io").readURI ' +
...
exports.base64Encode = function base64Encode(data) {
  console.error('require("api-utils/utils/data").base64Encode is deprecated, ' +
...
exports.base64Decode = function base64Decode(data) {
  console.error('require("api-utils/utils/data").base64Dencode is deprecated, ' +
