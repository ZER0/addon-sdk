...
function load(document) {
  ...
  // temporary fix for 3rd party module; some properties are not applied
  // if the element is not rendered, even if they're in inline style
  document.defaultView.getComputedStyle = function(node) node.style;
